	...
	var Arrows = {
		...
		_arrowsOnUpdate: function() {
			...
			if ( this.settings.arrows === true && this.$arrows === null ) {
				...
				this.$previousArrow = $( '<div class="sp-arrow sp-previous-arrow"><svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7 1L1 7L7 13" stroke="#292244" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></div>' ).appendTo( this.$arrows );
				this.$nextArrow = $( '<div class="sp-arrow sp-next-arrow"><svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 13L7 7L1 1" stroke="#292244" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></div>' ).appendTo( this.$arrows );
	...
	var ThumbnailArrows = {
		...
		_thumbnailArrowsOnUpdate: function() {
			...
			if ( this.settings.thumbnailArrows === true && this.$thumbnailArrows === null ) {
				...
				this.$previousThumbnailArrow = $( '<div class="sp-thumbnail-arrow sp-previous-thumbnail-arrow"><svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7 1L1 7L7 13" stroke="#292244" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></div>' ).appendTo( this.$thumbnailArrows );
				this.$nextThumbnailArrow = $( '<div class="sp-thumbnail-arrow sp-next-thumbnail-arrow"><svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 13L7 7L1 1" stroke="#292244" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></div>' ).appendTo( this.$thumbnailArrows );
